...
void Reminder::SmoothButtonAnim(sf::Sprite &button,
  ...
  if (button.getGlobalBounds().contains(mousePosition.x, mousePosition.y)) {
    if (button_st.alpha > 0 and !button_st.changedButton) {
      ...
      button.setColor(sf::Color(button_st.alpha,
                                button_st.alpha,
                                button_st.alpha,
...
bool Reminder::ShowRegisterField(sf::RenderWindow &mainWindow,
...
bool Reminder::JumpAnim(sf::RenderWindow &mainWindow,
                        sf::Sprite &button_log,
                        sf::Sprite &button_reg,
                        sf::Sprite &logo,
                        sf::Sprite &log_field,
  ...
  if (button_log.getPosition().x - 300 > windowSize.x and button_reg.getPosition().x + 300 < 0
      and logo.getPosition().y + 300 < 0 and log_field.getPosition().x + 100 < 0
      and pass_field.getPosition().x - 300 > windowSize.x) {
